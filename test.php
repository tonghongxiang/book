...
$query="SELECT * FROM book_list WHERE xiaolei ='$type' OR dalei='$type1'OR dalei='$type2'";
...
for($i=0;$i<$arr_row;$i++){
    ...
    echo "
    <div style='width: 170px;height: 250px;border: solid 1px white;display: inline-block;margin: 5px;float: left'>
    <a  href='book_descpt.php' style='position:relative;'><img id='$id' class='a_ll' src='../upload/$pc_name 'style='position:relative;left: 3px;width: 120px;'></a><br>
    <a id='$id' class='a_ll' href='book_descpt.php' style='position:relative;font-size: 0.8em'>$book_name</a><br>
